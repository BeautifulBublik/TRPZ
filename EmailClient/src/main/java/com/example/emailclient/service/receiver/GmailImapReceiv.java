...
public class GmailImapReceiv implements MailReceiverImap {
	...
	private String cleanHtml(String html) {
	    ...
	    html = html.replaceAll("(?i)<html[^>]*>", "<html><body style='font-family:Segoe UI, sans-serif; font-size:13px; color:#333;'>");
	    html += "</body></html>";
	    return html;
	}
}
