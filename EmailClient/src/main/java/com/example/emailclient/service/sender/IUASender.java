...
public class IUASender  extends AbstractMailSender implements EmailSender {
	    ...
	    public void connect(String from, String password) {
	        ...
	        String host = config.getProperty("iua.smtp.host");
	        String port = config.getProperty("iua.smtp.port");
