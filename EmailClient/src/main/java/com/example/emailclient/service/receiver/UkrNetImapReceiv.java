...
public class UkrNetImapReceiv implements MailReceiverImap {
	...
	public List<EmailMessage> receiveEMails(String email, String password, int limit) {
		...
		String host = config.getProperty("ukrnet.imap.host");
		String port = config.getProperty("ukrnet.imap.port");
